...
Each input consists of one test case, representing a single secure system. The first line contains an integer $n$ ($1 \le n \le 5\,000$), the number of passcodes in the firewall. Each of the next $n$ lines contains one passcode, a positive integer consisting of between $1$ and $100$ digits (inclusive).
